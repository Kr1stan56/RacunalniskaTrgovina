...
--
-- Gostitelj: 127.0.0.1
-- Čas nastanka: 05. jun 2025 ob 12.42
...
('images/case/prenos (1).jfif', 180, 'Corsair 4000D Airflow', 'Visoka pretočnost zraka', 89.99, 15, '2025-04-04', 2),
...
('images/cpu/ndnP1HfrC3H6.webp', 184, 'Intel Core i9-13900K', '24 jedra, 32 niti, 5.8GHz', 589.99, 8, '2025-04-04', 3),
...
('images/gpu/98062941.webp', 189, 'NVIDIA RTX 4090', '24GB GDDR6X, 4K gaming', 1599.99, 4, '2025-04-04', 4),
('images/gpu/prenos.jfif', 190, 'AMD Radeon RX 7900 XTXx', '24GB GDDR6, Ray Tracing', 999.99, 6, '2025-04-04', 4),
...
('images/headset/prenos.jfif', 199, 'Logitech G Pro X', 'Gaming headset, BLUE VO!CE mikrofon', 129.99, 15, '2025-04-04', 6),
...
('images/monitor/si-odyssey-g7-c27g75t-337453-lc32g75tqsrxen-thumb-431752835.webp', 214, 'Samsung Odyssey G7', 'Curved, 240Hz, 1ms odzivni čas', 499.99, 10, '2025-04-04', 9),
...
('images/headset/prenows.jfif', 234, 'Bose QuietComfort 35 II', 'Noise Cancelling, Bluetooth', 299.99, 15, '2025-04-04', 6),
...
INSERT INTO `kosarica` (`id_k`, `datum_ustvarjanja`, `status`) VALUES
(1, '2025-06-03', 1),
(2, '2025-06-03', 1),
(3, '2025-06-04', 1),
(4, '2025-06-04', 1),
...
INSERT INTO `narocila` (`id_n`, `datum_narocila`, `status_narocila`, `skupna_cena`, `naslov_dostave`, `nacin_placila`, `id_u`, `id_k`) VALUES
(0, '2025-06-04', 'novo', 1113.59, '123', 'kartica', 5, 3);
...
--
-- Odloži podatke za tabelo `postavke_kosarice`
--

INSERT INTO `postavke_kosarice` (`id_po_ko`, `kolicina`, `cena_ob_nakupu`, `id_k`, `id_i`) VALUES
(1, 1, 8.98, NULL, 175),
(2, 1, 8.98, NULL, 175),
(3, 1, 8.98, NULL, 175),
(4, 1, 12.5, NULL, 176),
...
(5, 'blaz', 'kristam', 'kristanblaz56@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '123', '2025-05-29', 3, 2),
(7, 'aljaz', 'roser', 'aljazroser69@gmail.com', '93a86f2356febbfae4eaaaa3238b2fa44436a5c3', 'lemberg 23, Nova Cerkev', '2025-06-04', 4, 1),
(8, 'USB-C to USB-A adapt', 'hg', 'bk@bk.si', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '123', '2025-06-04', 5, 1),
(9, 'test', 'test', 't@t.si', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '123', '2025-06-04', 6, 1),
(12, 'blaz', 'kristan', 'kristanblaz@scv.si', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Klanc 109,Dobrna', '2025-06-05', 7, 1);
...
--
-- AUTO_INCREMENT tabele `postavke_kosarice`
--
ALTER TABLE `postavke_kosarice`
  MODIFY `id_po_ko` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT tabele `postavke_narocila`
--
ALTER TABLE `postavke_narocila`
  MODIFY `id_po_na` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `narocila`
  ADD CONSTRAINT `Relationship10` FOREIGN KEY (`id_k`) REFERENCES `kosarica` (`id_k`),
...
--
ALTER TABLE `postavke_kosarice`
  ADD CONSTRAINT `Relationship3` FOREIGN KEY (`id_k`) REFERENCES `kosarica` (`id_k`),
...
--
ALTER TABLE `postavke_narocila`
  ADD CONSTRAINT `Relationship4` FOREIGN KEY (`id_n`) REFERENCES `narocila` (`id_n`),
...
--
ALTER TABLE `uporabniki`
  ADD CONSTRAINT `Relationship11` FOREIGN KEY (`id_k`) REFERENCES `kosarica` (`id_k`),
